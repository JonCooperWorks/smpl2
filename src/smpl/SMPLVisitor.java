...
public class SMPLVisitor implements Visitor<SMPLEnvironment, SMPLContainer> {
    ...
    public SMPLContainer visitFunCall(ASTFunCallExp funcall, SMPLEnvironment state) {
        ...
        /*if( !"Function".equals(funcToCallContainer.getType()) ){
            System.out.print("Invalid function call. Functions are required as the first parameter for 'call'.");
            return null;
        }*/
        ...
        if( "Function Call".equals(funcall.getName())){
            ...
            //SMPLContainer funcContainer = state.get(funcall.getName());
    ...
    public SMPLContainer visitAssign(ASTAssignExp assignExp, SMPLEnvironment state){
        ...
        //if( state.get(strVarName) == null )
        //    System.out.println("Use of an undefined variable: '" +strVarName + "'.");
        //else
    ...
    public SMPLContainer visitVecExp(ASTVecExp e, SMPLEnvironment state){
        ...
        SMPLContainer funcContainer = e.getFunction().visit(this, state);
        ...
        if( !"Function".equals(funcContainer.getType()) ){
            System.out.println("The vector expression requires a function.");
            return null;
        }*/
    ...
    public SMPLContainer visitCaseExp(ASTCaseExp e, SMPLEnvironment state){
        // Ammm.... yeah, this function shouldn't do anything...
        return null;
    }
